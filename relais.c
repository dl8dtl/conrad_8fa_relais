...
help (void)
{
  ...
  fprintf (stderr, "\n");
  fprintf (stderr, "Usage: relais -d <device name> [-e] [-h] [-s bitsequence] [-S]\n");
  fprintf (stderr, "\n");
  fprintf (stderr, "  -e: mehr Meldungen\n");
  fprintf (stderr, "  -h: diese Hilfe\n");
  fprintf (stderr, "  -s bitsequence: Relais-Schaltsequenz, 0 - aus, 1 - ein, x - halten\n");
  fprintf (stderr, "    Bsp: -s 1xxx01 - Relais 1 ein, 2 aus, 3,4,5 bleibt, 6 ein\n");
  fprintf (stderr, "  -S: Statusbericht, Ausgabe der gesetzen Relais dezimal\n");
  fprintf (stderr, "\n");
